...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'phone' => [
            'phone.format' => 'Должно быть номером телефона',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'visa_id'               => 'Виза',
        'calculator_title'      => 'Название в калькуляторе',
        'is_on_calculator_page' => 'Присустсвие на странице калькулятора',
        'order_title'           => 'Название на странице заказа',
        'is_on_order_page'      => 'Присустсвие на странице заказа',
        ...
        'date_end'              => 'Окончание поездки',
        'tickets'               => 'Наличие билетов',
        'hotel'                 => 'Наличие брони',
        'payment_method'        => 'Метод оплаты',

        'appliance_date'        => 'Дата подачи документов',
