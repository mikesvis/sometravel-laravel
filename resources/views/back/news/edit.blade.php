...
@section('header', 'Редактирование новости "'.$news->title.'"')

@section('content')

{{-- @include('back.components.errors') --}}

<form method="POST" action="{{ route('admin.news.update', $news->id) }}" id="mainForm">
        ...
        <div class="card-body">
            ...
            <div class="tab-content px-3 py-4">
                ...
                <div class="tab-pane fade {{ (($tabToGo == '#primary') ? "active show":"") }}" id="primary" role="tabpanel" aria-labelledby="primary">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-10">
                            ...
                            type="text"
                            name="country"
                            value="{{ old('country', $news->country) }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-2">
                            ...
                            type="number"
                            name="ordering"
                            value="{{ old('ordering', $news->ordering) }}"
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-lg-9 col-xl-10">
                            <div class="custom-control custom-checkbox">
                                ...
                                id="status"
                                @if ((bool)old('status', (bool)$news->status)) checked @endif
                                >
                ...
                <div class="tab-pane {{ (($tabToGo == '#images') ? "active show":"") }}" id="images" role="tabpanel" aria-labelledby="images">
                    @include('back.image.index', ['model'=>$news, 'images'=>$news->images])
                </div>
                {{-- /images --}}
                ...
                <div class="tab-pane {{ (($tabToGo == '#seo') ? "active show":"") }}" id="seo" role="tabpanel" aria-labelledby="seo">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-10">
                            ...
                            id="seo_description"
                            >{{ old('seo_description', $news->seo_description) }}</textarea>
