...
@section('header', 'Параметр визы "'.$parameter->title.'" для страны "'.$parameter->visa->title.'"')

@section('content')

{{-- @include('back.components.errors') --}}

<form method="POST" action="{{ route('admin.parameter.update', $parameter->id) }}">
                ...
                <div class="tab-pane fade active show" id="primary" role="tabpanel" aria-labelledby="primary">
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-lg-9 col-xl-10">
                            <div class="custom-control custom-checkbox">
                                ...
                                @if ((bool)old('is_on_calculator_page', $parameter->is_on_calculator_page)) checked @endif
                                >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-10">
                            ...
                            value="{{ old('calculator_title', $parameter->calculator_title) }}"
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-lg-9 col-xl-10">
                            <div class="custom-control custom-checkbox">
                                ...
                                class="custom-control-input"
                                id="is_on_order_page"
                                @if ((bool)old('is_on_order_page', $parameter->is_on_order_page)) checked @endif
                                >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-10">
                            ...
                            type="text"
                            name="order_title"
                            value="{{ old('order_title', $parameter->order_title) }}"
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-lg-9 col-xl-10">
                            <div class="custom-control custom-checkbox">
                                ...
                                class="custom-control-input"
                                id="required"
                                @if ((bool)old('required', $parameter->required)) checked @endif
                                >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-2">
                            ...
                            type="number"
                            name="ordering"
                            value="{{ old('ordering', $parameter->ordering) }}"
