                            ...
                            <div class="col-12 col-md-6 col-xxl-4 col-xxxl-3 mb-4">
                                ...
                                <div class="cabinet-form__panel panelRounded p-4 panelShadow">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group is-datepicker" id="datepicker_birthday" data-date-format="DD.MM.YYYY" data-target-input="nearest" data-date-defaultDate="false" data-date-use-current="false" data-date-max-date="{{ \Carbon\Carbon::now()->format('Y-m-d\TH:i:s.u\Z') }}">
                                                <input
                                                type="text"
                                                name="birthday"
                                                value="{{ old('birthday', $user->birthday_human) }}"
                                                id="input-birthday"
                                                class="textInput textInput--borderPrimary textInput--rounded textInput--biggerText form-control text-center datetimepicker-input @error('birthday')is-invalid @enderror"
