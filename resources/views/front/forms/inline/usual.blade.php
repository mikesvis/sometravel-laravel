            ...
            <div class="row justify-content-center vpm__mb">
                <div class="col-12 col-xxl-9 col-xxxl-7">
                    ...
                    <div class="feedbackForm mt-2">
                        <form action="{{ route('front.forms.inline') }}" method="POST" class="inline-feedbackform" data-form-id="#{{ $formId }}" id="{{ $formId }}">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-12 col-md-6 col-lg-4 col-xxl-5">
                                    <button type="submit" name="feedbackFormSubmit" class="submitButton submitButton--biggerForMobile btn btn-primary btn-block rounded-pill inline-form-submit">Отправить</button>
                                </div>
                                ...
                                <div class="col-12 col-md-10 col-xl-10 col-xxl-8 col-xxxl-10">
                                    <div class="feedbackForm__agreeText feedbackForm__agreeText--small text-muted text-center mt-4">
                                        Нажимая на кнопку &laquo;Отправить&raquo;, Вы подтверждаете свое совершеннолетие, соглашаетесь на обработку персональных данных в соответствии с <a href="/usloviya">Условиями</a>.
                                    </div>
                                </div>
