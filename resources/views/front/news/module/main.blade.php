...
<div class="news vpm__mb">
    <div class="container">
        ...
        <div class="listing row justify-content-center">
            ...
            <div class="col-12 col-md-6 col-xxl-4 mb-4 mb-lg-5 @if ($loop->last) d-none d-xxl-block @endif">
                @include('front.news.module.item', ['item' => $item, 'moreLinkClass' => 'listingText__moreLink'])
            </div>
            @endforeach
