...
return [
    ...
    */
    'columns' => [
        'alpha'   => [
            'rows'  => ['description', 'email', 'name','surname', 'patronymic', 'fio', 'slug'],
            'class' => 'fas fa-sort-alpha-down',
        ],
        'amount'  => [
            'rows'  => ['amount', 'price'],
            'class' => 'fas fa-sort-am-down',
        ],
        'numeric' => [
            'rows'  => ['created_at', 'updated_at', 'level', 'id', 'phone_number', 'phone', 'ordering', 'orders_count'],
